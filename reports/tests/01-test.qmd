...
## Inserindo células de cídigo

A @fig-glinha exibe um gráfico de linha de uma VA com distribuição normal
padronizada.

```{r}
#| echo: false
#| label: fig-glinha
#| fig-cap: "Gráfico de Linha de uma VA com distribução normal."

# Simulando uma VA com distribuição normal
Retornos <- rnorm(1000)

# gráfico dos retornos simulados
